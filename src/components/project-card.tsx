...
export default function ProjectCard({ project }: { project: ProjectInfo }) {
  return (
    <div className="flex items-center justify-between w-full max-w-md p-4 mx-auto transition duration-100 ease-in bg-white select-none md:max-w-none md:w-auto md:mx-0 drop-shadow-md hover:drop-shadow-lg dark:drop-shadow-none dark:ring-0 rounded-xl dark:bg-zinc-950/50 dark:hover:bg-zinc-800">
